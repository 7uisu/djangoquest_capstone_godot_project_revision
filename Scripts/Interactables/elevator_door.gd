# elevator_door.gd — Elevator door interactable with floor selection UI
# Attach to elevator_door_1.tscn root Area2D.
# Works like the school outdoor door: plays open animation, then shows a floor chooser.
extends Area2D
...
const FLOORS = [
	{
		"name": "Ground Floor",
		"scene": "res://Scenes/Ch3/main_office_3_floor_map.tscn",
		"spawn": Vector2(608, 8)  # Between the two elevator doors + offset
	},
	{
		"name": "2nd Floor",
		"scene": "res://Scenes/Ch3/Office Floors/main_office_3_floor_map_2nd_floor.tscn",
		"spawn": Vector2(608, 8)
	},
	{
		"name": "3rd Floor",
		"scene": "res://Scenes/Ch3/Office Floors/main_office_3_floor_map_3rd_floor.tscn",
		"spawn": Vector2(608, 8)
	}
]
